...
GRANT SELECT, UPDATE ON SEQUENCE ciceron.seq_d_subtitle_videos TO ciceron_web;
GRANT SELECT, UPDATE ON SEQUENCE ciceron.seq_d_subtitles_rows TO ciceron_web;
...
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE ciceron.d_subtitle_videos TO ciceron_web;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE ciceron.d_subtitles_rows TO ciceron_web;
