...
CREATE TABLE CIERON.D_I18N_VARIABLE_NAMES (
    id INT,
    text VARCHAR(100),
...
CREATE TABLE CICERON.F_I18N_VALUES (
    ...
    FOREIGN KEY (source_text_id) REFERENCES CICERON.F_I18N_TEXT_MAPPINGS (id),
    FOREIGN KEY (target_text_id) REFERENCES CICERON.F_I18N_TEXT_MAPPINGS (id)
);
