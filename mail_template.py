class mail_format:
    ...
    translator_new_ticket_en="""<img src='%(host)s/api/access_file/img/logo.png'><br>
                 ...
                 Jump into <a href='%(link)s' target='_blank'>here</a> and throw their worriness!<br>
                 <br>
                 Best regards,
                 Ciceron team"""

    def translator_new_ticket(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return translator_new_ticket_kr
            return translator_new_ticket_en
        elif language_id == 1:
            return translator_new_ticket_en
    ...
    def translator_check_expected_time(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return translator_check_expected_time_kr
            return translator_check_expected_time_en
        elif language_id == 1:
            return translator_check_expected_time_en
    ...
    def translator_complete(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return translator_complete_kr
            return translator_complete_en
        elif language_id == 1:
            return translator_complete_en
    ...
    def translator_exceeded_due(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return translator_exceeded_due_kr
            return translator_exceeded_due_en
        elif language_id == 1:
            return translator_exceeded_due_en
    ...
    def translator_extended_due(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return translator_extended_due_kr
            return translator_extended_due_en
        elif language_id == 1:
            return translator_extended_due_en
    ...
    def translator_no_answer_expected_time(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return translator_no_answer_expected_time_kr
            return translator_no_answer_expected_time_en
        elif language_id == 1:
            return translator_no_answer_expected_time_en
    ...
    def client_take_ticket(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return client_take_ticket_kr
            return client_take_ticket_en
        elif language_id == 1:
            return client_take_ticket_en
    ...
    def client_check_expected_time(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return client_check_expected_time_kr
            return client_check_expected_time_en
        elif language_id == 1:
            return client_check_expected_time_en
    ...
    def client_giveup_ticket(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return client_giveup_ticket_kr
            return client_giveup_ticket_en
        elif language_id == 1:
            return client_giveup_ticket_en
    ...
    def client_no_answer_expected_time_go_to_stoa(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return client_no_answer_expected_time_go_to_stoa_kr
            return client_no_answer_expected_time_go_to_stoa_en
        elif language_id == 1:
            return client_no_answer_expected_time_go_to_stoa_en
    ...
    def client_complete(language_id):
        if language_id == 0:
            # Later, should be Korean
    ...
    def client_incomplete(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return client_incomplete_kr
            return client_incomplete_en
        elif language_id == 1:
            return client_incomplete_en
    ...
    def client_no_hero(language_id):
        if language_id == 0:
            # Later, should be Korean
            # return client_no_hero_kr
            return client_no_hero_en
        elif language_id == 1:
            return client_no_hero_en
